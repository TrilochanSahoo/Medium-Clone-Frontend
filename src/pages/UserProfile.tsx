      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6">
          <div className="w-auto mx-16 space-y-6">
            ...
            <nav className="flex items-center text-sm justify-between" aria-label="Breadcrumb">
              <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                  <div className="flex items-center">
                    ...
                    <a href="#" className="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 ">Saved Posts</a>
                  </div>
                </li>
